...
rd_a_man = tk.Radiobutton(master=frm_a, text="Manual Speed control")
btn_a_mm = tk.Button(master=frm_a, text="<<", width=3)
btn_a_m = tk.Button(master=frm_a, text="<", width=3)
lbl_a_spd = tk.Label(master=frm_a, text="+100%", width=6, textvariable=lbl_a_spd_text, relief=tk.SUNKEN)
btn_a_p = tk.Button(master=frm_a, text=">", width=3)
btn_a_pp = tk.Button(master=frm_a, text=">>", width=3)
...
rd_a_aut = tk.Radiobutton(master=frm_a, text="Automatic Position control")
lbl_a_pos = tk.Label(master=frm_a, text="Step:", width=6)
spn_a_pos = tk.Spinbox(master=frm_a, from_= -25.00, to = 25.00, width=5)
lbl_a_mm = tk.Label(master=frm_a, text="mm", width=3)
btn_a_go = tk.Button(master=frm_a, text="GO", width=3, bg="green", activebackground="green")

rd_a_aut.grid(row=2, column=0, columnspan = 6, padx=4, pady=4, sticky = tk.W)
lbl_a_pos.grid(row=3, column=0, padx=4, pady=4, sticky = tk.W)
spn_a_pos.grid(row=3, column=1, columnspan = 2, padx=4, pady=4, sticky = tk.W)
lbl_a_mm.grid(row=3, column=2, columnspan = 1, padx=4, pady=4)
...
btn_b_mm = tk.Button(master=frm_b, text="<<", width=3)
btn_b_m = tk.Button(master=frm_b, text="<", width=3)
lbl_b_spd = tk.Label(master=frm_b, text="+100%", width=6, textvariable=lbl_b_spd_text, relief=tk.SUNKEN)
btn_b_p = tk.Button(master=frm_b, text=">", width=3)
btn_b_pp = tk.Button(master=frm_b, text=">>", width=3)
...
btn_c_mm = tk.Button(master=frm_c, text="<<", width=3)
btn_c_m = tk.Button(master=frm_c, text="<", width=3)
lbl_c_spd = tk.Label(master=frm_c, text="+100%", width=6, textvariable=lbl_c_spd_text, relief=tk.SUNKEN)
btn_c_p = tk.Button(master=frm_c, text=">", width=3)
btn_c_pp = tk.Button(master=frm_c, text=">>", width=3)
