...
lbl_a_stp = tk.Label(master=frm_a, text="Step:", width=6)
...
lbl_a_pos = tk.Label(master=frm_a, text="Position:", width=9)
...
btn_a_go = tk.Button(master=frm_a, text="ZERO", width=3, bg="yellow", activebackground="yellow")
