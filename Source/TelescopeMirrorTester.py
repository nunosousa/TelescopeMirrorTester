...
if test == 158:
    # Test data - Test 158
    r = np.array([42.80, 45.50, 48.06, 52.01, 55.00, 58.03, 61.29, 63.66, 65.85, 70.51, 71.83, 76.65, 78.26])
    f = np.array([0.20, 0.30, 0.40, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00, 1.10, 1.20, 1.30, 1.40])
